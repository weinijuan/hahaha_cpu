...
extern "C" {
    ...
    // DPI IMPORTS
    // DPI import at ../testbench/difftest.v:185
    ...
    // DPI import at ../testbench/difftest.v:92
    extern void v_difftest_ExcpEvent(char coreid, char excp_valid, unsigned char eret, int intrNo, int cause, long long exceptionPC, int exceptionInst);
    // DPI import at ../testbench/difftest.v:255
    ...
    // DPI import at ../testbench/difftest.v:50
    extern void v_difftest_InstrCommit(char coreid, char index, unsigned char valid, long long pc, int instr, unsigned char skip, unsigned char is_TLBFILL, char TLBFILL_index, unsigned char is_CNTinst, long long timer_64_value, unsigned char wen, char wdest, long long wdata, unsigned char csr_rstat, int csr_data);
    // DPI import at ../testbench/difftest.v:164
    extern void v_difftest_LoadEvent(char coreid, char index, char valid, long long paddr, long long vaddr);
    // DPI import at ../testbench/difftest.v:140
    ...
    // DPI import at ../testbench/difftest.v:117
    extern void v_difftest_TrapEvent(char coreid, unsigned char valid, char code, long long pc, long long cycleCnt, long long instrCnt);
